...
class DartSyntaxHighlighter extends SyntaxHighlighter {
  DartSyntaxHighlighter({required this.syntaxHighlighterStyle}) {
    ...
    if (_generateSpans()) {
      ...
      for (final _HighlightSpan span in _spans) {
        ...
        formattedText.add(TextSpan(
            style: span.textStyle(syntaxHighlighterStyle),
      ...
      return TextSpan(
          style: syntaxHighlighterStyle.baseStyle, children: formattedText);
    } else {
      // Parsing failed, return with only basic formatting
      return TextSpan(style: syntaxHighlighterStyle.baseStyle, text: src);
    }
  }
...
abstract class SyntaxHighlighterStyle {
  TextStyle? get baseStyle;
  TextStyle? get numberStyle;
  TextStyle? get commentStyle;
  TextStyle? get keywordStyle;
  TextStyle? get stringStyle;
  TextStyle? get punctuationStyle;
  TextStyle? get classStyle;
